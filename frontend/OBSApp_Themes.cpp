...
void OBSApp::FindThemes()
{
	...
	{
		const std::string themeDir = App()->userConfigLocation.u8string() + "/wear-stream-studio/themes";
...
bool OBSApp::SetTheme(const QString &name)
{
	...
	string filename("wear-stream-studio/themes/");
...
bool OBSApp::InitTheme()
{
	...
	char userDir[512];
	if (GetAppConfigPath(userDir, sizeof(userDir), "wear-stream-studio/themes")) {
